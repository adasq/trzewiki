...
--
-- Host: localhost
-- Czas wygenerowania: 16 May 2014, 20:17
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `deleted` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=201 ;
...
(1, 1, NULL, 'przykladowa akcja admina', 'cusotm1', NULL, NULL, 0),
(2, NULL, 1, 'przykladowa akcja klienta', NULL, NULL, NULL, 0),
(3, NULL, NULL, 'niczyja akcja', NULL, NULL, NULL, 0);
